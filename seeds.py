...
examples = [
    ...
    ('@A_I_A_LLY\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n@A_I_A_LLY', "BAN"),
    ('cld u contact @Kenwei021201 and meet him near tembu? this is my friends but i’m not in utown to fetch it for him', "SAFE"),
    ...
    ('Pm now^', "BAN"),
    ('FUCK', "BAN"),
    ('𝐇𝐢 𝐞𝐯𝐞𝐫𝐲𝐨𝐧𝐞,  \n\n𝐆𝐢𝐯𝐢 𝐧𝐠 𝐚𝐰𝐚𝐲 2 × 3𝐬𝐢𝐱𝐭𝐲 16 𝐢𝐧𝐜𝐡 𝐟𝐨𝐥𝐝𝐚𝐛𝐥𝐞 𝐛𝐢𝐜𝐲𝐜𝐥𝐞𝐬 (𝐜𝐡𝐚𝐦𝐞𝐥𝐞𝐨𝐧 𝐛𝐥𝐮𝐞 & 𝐫𝐞𝐝)  𝐛𝐨𝐭𝐡 𝐢𝐧 𝐠𝐨𝐨𝐝 𝐰𝐨𝐫𝐤𝐢𝐧𝐠 𝐜𝐨𝐧𝐝𝐢𝐭𝐢𝐨𝐧.  𝐆𝐫𝐞𝐚𝐭 𝐟𝐨𝐫 𝐜𝐨𝐦𝐦𝐮𝐭𝐢𝐧𝐠 𝐨𝐫 𝐜𝐚𝐬𝐮𝐚𝐥 𝐫𝐢𝐝𝐞𝐬.  \n\n𝐈𝐟 𝐲𝐨𝐮 a𝐫𝐞 𝐢𝐧𝐭𝐞𝐫𝐞𝐬𝐭𝐞 𝐝, 𝐟𝐞𝐞𝐥 𝐟𝐫𝐞𝐞 𝐭𝐨 𝐃 𝐌. \n\n𝐓𝐡𝐚𝐧𝐤𝐬.', "BAN"),
    ('Pm now', "BAN"),
]
